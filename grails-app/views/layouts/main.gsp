...
<body>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6Ldza_wcAAAAALobAKzBPhpl7WfO1aM5mBtsuNxb"></script>
...
<script>
        function onSubmitCaptcha(e) {
            e.preventDefault();
            grecaptcha.ready(function() {
                grecaptcha.execute('6Ldza_wcAAAAALobAKzBPhpl7WfO1aM5mBtsuNxb', {action: 'submit'}).then(function(token) {
